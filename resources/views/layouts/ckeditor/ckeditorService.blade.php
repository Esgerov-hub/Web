<script src="{{ asset('dashboard/plugins/ckeditor/ckeditor.js') }}" type="text/javascript"></script>
<script>
    ...
    for(var i=0;i<40;i++){ newEditor("faq_tab_"+i.toString()); } @else ClassicEditor
        .create(document.querySelector('.{{ $editor }}'), { extraPlugins: [SimpleUploadAdapterPlugin], })
        .then(editor=> {
