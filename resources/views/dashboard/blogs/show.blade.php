        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form
                        action="{{ route('blogs.show',$blog->id) }}"
                        method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-content-below-tabContent">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="category_id" id="" class="form-control @error('category_id') is-invalid @enderror" disabled>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="type" required class="form-control"  disabled>
                                                            <option value="0" @if(isset($blog)) @if($blog->type == 0) selected @endif @elseif(old('type') == 0) selected @endif>Bir tip seçin</option>
                                                            <option value="1" @if(isset($blog)) @if($blog->type == 1) selected @endif @elseif(old('type') == 1) selected @endif>Servis</option>
                                                            <option value="2" @if(isset($blog)) @if($blog->type == 2) selected @endif @elseif(old('type') == 2) selected @endif>Məqalə</option>
                                                            <option value="3" @if(isset($blog)) @if($blog->type == 3) selected @endif @elseif(old('type') == 3) selected @endif>Məhsul</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="az" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" disabled class="form-control @error('az_name') is-invalid @enderror" name="az_name" value="@if(isset($blog)) {{ $blog->title['az_name'] }} @else {{ old('az_name') }} @endif" >

                                    </div>

                                    <div class="form-group">
                                        <textarea class="form-control az_description"
                                                  placeholder="Açıqlama daxil edin ..." disabled name="az_description"
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" disabled class="form-control @error('en_name') is-invalid @enderror" name="en_name" value="@if(isset($blog)) {{ $blog->title['en_name'] }} @else {{ old('en_name') }} @endif" >
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" disabled class="form-control @error('ru_name') is-invalid @enderror" name="ru_name" value="@if(isset($blog)) {{ $blog->title['ru_name'] }} @else {{ old('ru_title') }} @endif" >

                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control ru_description @error('ru_description') is-invalid @enderror" id="summernote"
                                        disabled   placeholder="Açıqlama daxil edin ..." name="ru_description"
