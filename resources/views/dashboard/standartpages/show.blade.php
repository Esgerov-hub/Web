        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form
                        action="{{  route('standart-pages.show',$standartPage->id) }}"
                        method="POST"
                            ...
                            <div class="tab-content" id="custom-content-below-tabContent">
                                <div class="tab-pane fade show active" id="image" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Type</label>
                                        <input type="text" disabled class="form-control @error('type') is-invalid @enderror" name="type" value="@if(isset($standartPage)) {{ $standartPage->type }} @else {{ old('type') }} @endif">
                                ...
                                <div class="tab-pane fade" id="az" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" disabled class="form-control @error('az_name') is-invalid @enderror" name="az_name" value="@if(isset($standartPage)) {{ $standartPage->name['az_name'] }} @else {{ old('az_name') }} @endif" >

                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control az_description" disabled
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" disabled class="form-control @error('en_name') is-invalid @enderror" name="en_name" value="@if(isset($standartPage)) {{ $standartPage->name['en_name'] }} @else {{ old('en_name') }} @endif" >

                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control en_description" disabled
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" disabled class="form-control @error('ru_name') is-invalid @enderror" name="ru_name" value="@if(isset($standartPage)) {{ $standartPage->name['ru_name'] }} @else {{ old('ru_name') }} @endif" >

                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control ru_description @error('ru_description') is-invalid @enderror" id="summernote"
                                                  placeholder="Açıqlama daxil edin ..." name="ru_description" disabled
