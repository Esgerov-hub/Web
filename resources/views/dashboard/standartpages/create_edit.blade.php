...
@section('title')
    @if(isset($standartPage) && $standartPage != null)
         StandartPages Edit
    @else
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form
                        action="{{ isset($standartPage) && $standartPage!=null ? route('standart-pages.update',$standartPage->id) :route('standart-pages.store') }}"
                        method="POST"
                    ...
                    <!-- /.card-header -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-content-below-tabContent">
                                <div class="tab-pane fade show active" id="image" role="tabpanel"
                                    ...
                                    <div class="avatar-lg">
                                        <div class="avatar-title bg-light rounded">
                                            <img src="{{ isset($standartPage) && $standartPage != null && isset($standartPage->bg_image) ? $standartPage->bg_image : asset('assets/images/favicon.ico') }}"
                                    ...
                                    <div class="form-group">
                                        <label>Image</label>
                                        <input type="file" class="form-control @error('bg_image') is-invalid @enderror" name="bg_image"  >

                                    </div>
                                    <div class="form-group">
                                        <label>Type</label>
                                        <select class="form-control @error('type') is-invalid @enderror" name="type">
                                            <option value="about" @if(isset($standartPage) && $standartPage!=null) @if($standartPage->type == "about") selected @endif @endif>About</option>
                                            <option value="service" @if(isset($standartPage) && $standartPage!=null) @if($standartPage->type == "service") selected @endif @endif>Service</option>
                                            <option value="slide" @if(isset($standartPage) && $standartPage!=null) @if($standartPage->type == "slide") selected @endif @endif>Slider</option>
                                        </select>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="az" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control @error('az_name') is-invalid @enderror" name="az_name" value="@if(isset($standartPage)) {{ $standartPage->name['az_name'] }} @else {{ old('az_name') }} @endif" >
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control az_description"
                                                  ...
                                                  style="width: 100%; height: 300px; font-size: 14px; line-height: 23px;padding:15px;">@if(isset($standartPage)) {!! $standartPage->description['az_description'] !!} @else {!! old('az_description') !!} @endif</textarea>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control @error('en_name') is-invalid @enderror" name="en_name" value="@if(isset($standartPage)) {{ $standartPage->name['en_name'] }} @else {{ old('en_name') }} @endif" >
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text" class="form-control @error('ru_name') is-invalid @enderror" name="ru_name" value="@if(isset($standartPage)) {{ $standartPage->name['ru_name'] }} @else {{ old('ru_name') }} @endif" >
                        ...
                        <div class="card-footer">
                            <div class="col-12">
                                <a href="{{ route('standart-pages.index') }}" class="btn btn-secondary">Cancel</a>
