        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form
                        action="{{ isset($project) && $project!=null ? route('projects.update',$project->id) :route('projects.store') }}"
                        method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="custom-content-below-tabContent">
                                <div class="tab-pane fade show active" id="other" role="tabpanel"
                                            ...
                                            @if(isset($project) && $project != null)
                                                <div class="avatar-lg">
                                                    <div class="avatar-title bg-light rounded">
                                                        <img src="{{ isset($project) && $project != null && isset($project->image) ? $project->image : asset('assets/images/favicon.ico') }}"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="status" id="" class="form-control">
                                                        ...
                                                        <option value="1" @if(isset($project)) @if($project->status == 1) selected @endif @elseif(old('status') == 1) selected @endif>Davam edir</option>
                                                        <option value="2" @if(isset($project)) @if($project->status == 2) selected @endif @elseif(old('status') == 2) selected @endif>Bitib</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="active" id="" class="form-control">
                                                        <option value="">Bir active seçin</option>

                                                        <option value="1" @if(isset($project)) @if($project->status == 1) selected @endif @elseif(old('status') == 1) selected @endif>Active</option>
                                                        <option value="2" @if(isset($project)) @if($project->status == 2) selected @endif @elseif(old('status') == 2) selected @endif>NoActive</option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Url</label>
                                                <input type="text" class="form-control @error('url') is-invalid @enderror" name="url" value="@if(isset($project)) {{ $project->url }} @else {{ old('url') }} @endif" >
                                ...
                                <div class="tab-pane fade" id="az" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control @error('az_name') is-invalid @enderror" name="az_name" value="@if(isset($project)) {{ $project->title['az_name'] }} @else {{ old('az_name') }} @endif" >
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control @error('en_name') is-invalid @enderror" name="en_name" value="@if(isset($project)) {{ $project->title['en_name'] }} @else {{ old('en_name') }} @endif" >
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" class="form-control @error('ru_name') is-invalid @enderror" name="ru_name" value="@if(isset($project)) {{ $project->title['ru_name'] }} @else {{ old('ru_title') }} @endif" >
