    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@if(isset($partner) && $partner !=null)
                                Partners Edit
                            @else
                                Partners Create
                            @endif</h1>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form
                        action="{{ isset($partner) && $partner!=null ? route('partners.update',$partner->id) :route('partners.store') }}"
                        method="POST"
                                ...
                                <div class="tab-pane fade show active" id="image" role="tabpanel"
                                    ...
                                    <div class="avatar-lg">
                                        @if(isset($partner) && $partner!=null)
                                            <div class="avatar-title bg-light rounded">
                                                <img
                                                    src="{{ isset($partner) && $partner != null && isset($partner->image) ? $partner->image : asset('assets/images/favicon.ico') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('url') is-invalid @enderror"
                                               name="url"
                                               value="{{ isset($partner) && $partner!=null ? $partner->url : null }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('order') is-invalid @enderror"
                                               name="order"
                                               value="{{ isset($partner) && $partner!=null ? $partner->order : null }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror"
                                                name="status">
                                            <option value="1"
                                                    @if(isset($partner) && $partner!=null) @if($partner->status == 1) selected @endif @endif>
                                                Active
                                            </option>
                                            <option value="2"
                                                    @if(isset($partner) && $partner!=null) @if($partner->status == 2) selected @endif @endif>
                                                NoActive
                                            </option>
                                        </select>
                                ...
                                <div class="tab-pane fade" id="az" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('az_name') is-invalid @enderror"
                                               name="az_name"
                                               value="{{ isset($partner) && $partner!=null ? isset($partner->name['az_name']) ? $partner->name['az_name'] : null : null }}">
                                ...
                                <div class="tab-pane fade" id="en" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('en_name') is-invalid @enderror"
                                               name="en_name"
                                               value="{{ isset($partner) && $partner!=null ? isset($partner->name['en_name']) ? $partner->name['en_name'] : null : null }}">
                                ...
                                <div class="tab-pane fade" id="ru" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('ru_name') is-invalid @enderror"
                                               name="ru_name"
                                               value="{{ isset($partner) && $partner!=null ? isset($partner->name['ru_name']) ? $partner->name['ru_name'] : null : null }}">
