                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Example:Users" style="width: 100%;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('permissions') is-invalid @enderror" name="permissions" placeholder="Example:Users view,Users create,Users edit,Users delete" style="width: 100%;">
                                    </div>
                                    <!-- /.form-group -->
                                </div>
                                <!-- /.col -->
