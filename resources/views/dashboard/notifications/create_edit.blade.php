        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form action="@if(isset($notification) && $notification != null) {{ route('notifications.update',$notification->id) }} @else {{ route('notifications.store') }} @endif" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($notification) && $notification != null)
                        @method('PUT')
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="text"
                                         class="form-control @error('name_surname') is-invalid @enderror" 
                                          name="name_surname"
                                    ...
                                    <div class="form-group">
                                        <label>Type</label>
                                        <select class="form-control @error('type') is-invalid @enderror" id="type-dd" name="type" style="width: 100%;">
                                    ...
                                    <div class="form-group">
                                        <label>Via</label>
                                        <select class="form-control @error('via') is-invalid @enderror"  name="via" style="width: 100%;">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('value') is-invalid @enderror" name="value" value="@if(isset($notification) && $notification != null){{ $notification->value }}@else {{ old('value') }} @endif" placeholder="Text..." style="width: 100%;">

                                    </div>
                                    <div class="form-group">
                                        <label>Users</label>
                                        <select  id="user-dd" class="form-control"  name="user_id" style="width: 100%;">   
            ...
            $('#type-dd').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        $('#user-dd').html('<option value="">-sec</option>');
