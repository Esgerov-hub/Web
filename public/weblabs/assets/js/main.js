!function (e) {
    ...
    var t, s, a, o = "", n = ".scrollToTop";

    function i(t) {
        var s = t, a = "is-invalid", o = '[name="email"]',
            n = '[name="name"],[name="email"],[name="subject"],[name="message"]', i = e(t).next(".form-messages");
        ...
        function l() {
            ...
            t = function () {
                ...
                return i
            }(), t && jQuery.ajax({url: e(s).attr("action"), data: l, type: "POST"}).done((function (t) {
    ...
    e(window).on("scroll", (function () {
        ...
        e(this).on("click", (function (t) {
            return t.preventDefault(), console.log("scroll to top clicked"), e("html, body").animate({scrollTop: 0}, 1e3), !1
        }))
    })), e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function () {
        var t = e(this).attr("data-bg-src");
        e(this).css("background-image", "url(" + t + ")"), e(this).removeAttr("data-bg-src").addClass("background-image")
    })), e(".vs-hero-carousel").each((function () {
        var t = e(this), s = e => t.data(e);
        t.on("sliderDidLoad", (function (s, a) {
            var o = ".ls-custom-dot", n = "data-slide-go", i = a.slides.current.index, l = 1;
            e(o).each((function () {
        ...
        type: "image",
        gallery: {enabled: !0}
    }), e(".popup-video").magnificPopup({type: "iframe"}), e.fn.sectionPosition = function (t, s, a) {
    ...
    function d(e) {
        var t = e.siblings(".indicator"), s = e.css("width"), a = e.css("height"), o = e.position().left,
            n = e.position().top;
    ...
    if (e(c).length && e(c).imagesLoaded((function () {
        ...
        var t = ".filter-active", s = ".filter-active2", a = ".filter-item";
        if (e(t).length > 0) var o = e(t).isotope({itemSelector: a, filter: "*", masonry: {columnWidth: 1}});
        if (e(s).length > 0) o = e(s).isotope({itemSelector: a, filter: "*", masonry: {columnWidth: a}});
        e(".filter-menu-active").on("click", "button", (function (t) {
            t.preventDefault();
            var s = e(this).attr("data-filter");
            o.isotope({filter: s}), e(this).addClass("active"), e(this).siblings(".active").removeClass("active")
        }))
        ...
        e(this).find("a").each((function () {
            e(this).on("click", (function (t) {
                ...
                s.length && (t.preventDefault(), event.preventDefault(), e("html, body").stop().animate({scrollTop: s.offset().top - 10}, 1e3))
            }))
        }))
    })), new WOW({
        boxClass: "wow",
